...
def main():
    ...
    parser.add_argument('--product-key', required=True, help='Product key under which to create devices')
    ...
    # Output filename
    output_file = f"batch_devices_{args.product_key}.json"
    
    try:
        # Create the devices
        print(f"Creating {args.device_count} devices under product '{args.product_key}'...")
